...
class DQAgent:
    ...
    def train(self):
        ...
        epsilon_random_frames = 100  # 50_000
        ...
        self.q_network.save("Boxing_Q_network.keras")

    def load_model(self):
        print("Loading model...")
        self.q_network = tf.keras.models.load_model("Boxing_Q_network.keras", safe_mode=False,
...
if __name__ == "__main__":
    ...
    agent = DQAgent("BoxingNoFrameskip-v4", max_iters=100, max_steps=1_000)  # , render_mode="human")
